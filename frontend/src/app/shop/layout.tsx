          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" role="img" aria-labelledby="instagram-icon-title">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" role="img" aria-labelledby="kakaotalk-icon-title">
                    <title id="kakaotalk-icon-title">KakaoTalk</title>
